...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-light border-0 py-3">
        ...
        <form class="row g-2" method="GET" action="{{ route('stock.details') }}">
            ...
            <div class="col-md-2">
                <input type="text" name="id_article" class="form-control form-control-sm" 
                       placeholder="Article" value="{{ request('id_article') }}">
            </div>
            <div class="col-md-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <small class="badge bg-info">
                                        {{ $fille->mvtStock->magasin?->libelle ?? $fille->mvtStock->magasin?->designation ?? 'N/A' }}
                                    </small>
                                </td>
                                <td>
