                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('id_entite') is-invalid @enderror" 
                                    ...
                                    @foreach($entites as $entite)
                                        <option value="{{ $entite->id_entite }}">{{ $entite->nom }}</option>
                                    @endforeach
                                </select>
                                @error('id_entite')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('id_type_evaluation_stock') is-invalid @enderror" 
                                    ...
                                    @foreach($typeEvaluations as $type)
                                        <option value="{{ $type->id_type_evaluation_stock }}">{{ $type->libelle }} ({{ $type->id_type_evaluation_stock }})</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('prix_vente') is-invalid @enderror" 
                                       id="prix_vente" name="prix_vente" placeholder="0.00" min="0" step="0.01" required>
